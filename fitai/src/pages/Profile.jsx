        ...
        <div className="flex gap-2">
          {editing && (
            <button onClick={cancel}
              className={`px-3 py-2 rounded-xl font-bold text-xs flex items-center gap-1 ${dm ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-600'}`}>
              <Icon path={mdiClose} size={0.65} /> Cancel
            </button>
          )}
